...
if you are using caffe model:
    ...
    ~/working/model.prototext   <--  your mod
...
WORKING_DIRECTORY = 'fast_repvgg/working'                             # choose your working directory
...
CALIBRATION_BATCHSIZE = 4                             # batchsize of calibration dataset
